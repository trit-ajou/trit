...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="skip",
        choices=["skip", "train", "inference", "pretrained", "pretrained-train", "pretrained-final"],
    )
    ...
    parser.add_argument(
        "--weight_decay", type=float, default=PipelineSetting.weight_decay
    )
    parser.add_argument(
        "--vis_interval", type=int, default=PipelineSetting.vis_interval
    )
    parser.add_argument(
        "--ckpt_interval", type=int, default=PipelineSetting.ckpt_interval
    )
    parser.add_argument(
        "--timg_generation",
        type=str,
        default="generate_only",
        choices=["generate_only", "generate_save", "use_saved", "test"],
    )
...
if __name__ == "__main__":
    ...
    if args.model3 == "skip":
        ...
        setting.model3_mode = ModelMode.PRETRAINED_INFERENCE
    elif args.model3 == "pretrained-train":
        setting.model3_mode = ModelMode.PRETRAINED_TRAIN
    elif args.model3 == "pretrained-final":
        setting.model3_mode = ModelMode.PRETRAINED_FINAL
